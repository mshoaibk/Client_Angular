...
export class EditPostJobService {
  ...
  GetPostedJobById(postJobId:any) {
    let url = this.Constants.urlGetPostedJobById + '/' + postJobId;;
    return this.Common.get(url);
  }

  EditPostedJob(jobComposeRqstModel: any): Observable<any> {
    let model = {
      ...
      "requiredSkill": jobComposeRqstModel.requiredSkill,
